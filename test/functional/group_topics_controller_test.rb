...
class GroupTopicsControllerTest < ActionController::TestCase
  ...
  test "should create group_topic" do
    assert_difference('GroupTopic.count') do
      post :create, group_topic: { group_id: @group_topic.group_id, status: @group_topic.status, topic_id: @group_topic.topic_id }
    end
  ...
  test "should update group_topic" do
    put :update, id: @group_topic, group_topic: { group_id: @group_topic.group_id, status: @group_topic.status, topic_id: @group_topic.topic_id }
    assert_redirected_to group_topic_path(assigns(:group_topic))
  end
